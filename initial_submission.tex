...
\begin{table}[h]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Test accuracies for each combination of test person, method type and \% of data from test subject used in training. $P_i$ denotes the $i^{th}$ person and $\bar{P}$ denotes the average accuracy of all subjects}
